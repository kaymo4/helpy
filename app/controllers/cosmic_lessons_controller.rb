class CosmicLessonsController < ApplicationController
  ...
  private
    ...
    def cosmic_lesson_params
      params.require(:cosmic_lesson).permit(:seo_key, :cosmic_domain, :cosmic_domain_order, :title_short, :title_long, :overview, :content, :type, :custom1, :custom2, :ccss_math_id)
    end
end
