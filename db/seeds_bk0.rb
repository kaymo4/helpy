...
# Create email header and footer template
...
# create example lesson and activity


cosmic_lesson = Cosmic_Lesson.create!(
  seo_key: 'fraction',
...
cosmic_activity = Cosmic_Activity.create!(
  seo_key: 'number_line',
  title_short:'Class obervation about number lines and rational numbers',
